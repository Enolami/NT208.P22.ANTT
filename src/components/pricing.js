...
const Pricing = (props) => {
  ...
  return (
    <div id={props.id} className="pricing-pricing23 thq-section-padding">
      <div className="pricing-max-width thq-section-max-width">
        <div className="pricing-section-title">
          <span className="pricing-text100 thq-body-small">
            {props.content1 ?? (
                <span>
          ...
          <div className="pricing-content">
            <h2 className="pricing-text101 thq-heading-2">
              {props.heading1 ?? (
                  <span>Pricing plan</span>
              )}
            </h2>
            <p className="pricing-text102 thq-body-large">
              {props.content2 ?? (
                  <span>
            ...
            <div className="pricing-column1 thq-card">
              <div className="pricing-price10">
                <div className="pricing-price11">
                  <p className="pricing-text107 thq-body-large">
                    {props.plan1 ?? (  
                        <span>Basic plan</span>    
                    )}
                  </p>
                  <h3 className="pricing-text108 thq-heading-3">
                    {props.plan1Price ?? (  
            ...
            <div className="pricing-column2 thq-card">
              <div className="pricing-price12">
                <div className="pricing-price13">
                  <p className="pricing-text114 thq-body-large">
                    {props.plan2 ?? (  
                        <span>Business plan</span>    
                    )}
                  </p>
                  <h3 className="pricing-text115 thq-heading-3">
                    {props.plan2Price ?? (  
            ...
            <div className="pricing-column3 thq-card">
              <div className="pricing-price14">
                <div className="pricing-price15">
                  <p className="pricing-text122 thq-body-large">
                    {props.plan3 ?? (  
                        <span>
                          Enterprise plan
                        </span>    
                  ...
                  <h3 className="pricing-text123 thq-heading-3">
                    {props.plan3Price ?? (  
            ...
            <div className="pricing-column4 thq-card">
              <div className="pricing-price16">
                <div className="pricing-price17">
                  <span className="pricing-text131 thq-body-large">
                    {props.plan11 ?? (
                          <span>Basic plan</span>    
                    )}
                  </span>
                  <h3 className="pricing-text132 thq-heading-3">
                    {props.plan1Price1 ?? (  
                        <span>$200/yr</span>    
                    )}
                  </h3>
            ...
            <div className="pricing-column5 thq-card">
              <div className="pricing-price18">
                <div className="pricing-price19">
                  <span className="pricing-text138 thq-body-large">
                    {props.plan21 ?? (  
                        <span>Business plan</span>    
                    )}
                  </span>
                  <h3 className="pricing-text139 thq-heading-3">
                    {props.plan2Price1 ?? (  
                        <span>$299/yr</span>    
                    )}
                  </h3>
            ...
            <div className="pricing-column6 thq-card">
              <div className="pricing-price20">
                <div className="pricing-price21">
                  <span className="pricing-text146 thq-body-large">
                    {props.plan31 ?? (  
                        <span>
                          Enterprise plan
                        </span>    
                  ...
                  <h3 className="pricing-text147 thq-heading-3">
                    {props.plan3Price1 ?? (  
                        <span>$499/yr</span>    
                    )}
                  </h3>
