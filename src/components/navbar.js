...
const Navbar = (props) => {
  ...
  return (
    <header id={props.id} className="navbar-container1">
      <header data-thq="thq-navbar" className="navbar-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar-desktop-menu">
          <nav className="navbar-links1">
            <a
              href={props.link1Url}
              className="navbar-link11 thq-link thq-body-small"
            >
              {props.link1 ?? (
                  <span>#home</span>
              )}
        ...
        <div data-thq="thq-mobile-menu" className="navbar-mobile-menu">
          <div className="navbar-nav">
            ...
            <nav className="navbar-links2">
              <a
                href={props.link1Url}
                className="navbar-link12 thq-link thq-body-small"
              >
                {props.link1 ?? (
                    <span>#home</span>
              ...
              <a
                href={props.link3Url}
                className="navbar-link32 thq-link thq-body-small"
              >
                {props.link3 ?? (
                    <span>#integration</span>
                        ...
                        <div className="navbar-content2">
                          ...
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                                ...
                                <span>
                                  Explore the powerful features of our
                                  scheduling tool
                                </span>
                        ...
                        <div className="navbar-content3">
                          ...
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                                ...
                                <span>
                                  Discover how to sync with Google calendar and
                                  Outlook
                                </span>
        ...
        {link5DropdownVisible && (
          <div className="navbar-container7 thq-box-shadow">
            <div className="navbar-link5-menu-list">
              <a href={props.linkUrlPage1}>
                <div className="navbar-menu-item5">
                  <img
                    alt={props.page1ImageAlt}
                    src={props.page1ImageSrc}
                    className="navbar-page1-image2 thq-img-ratio-1-1"
                  />
                  <div className="navbar-content5">
                    <span className="navbar-page12 thq-body-large">
                      {props.page1 ?? (
              ...
              <a href={props.linkUrlPage2}>
                <div className="navbar-menu-item6">
                  <img
                    alt={props.page2ImageAlt}
                    src={props.page2ImageSrc}
                    className="navbar-page2-image2 thq-img-ratio-1-1"
                  />
                  <div className="navbar-content6">
                    <span className="navbar-page22 thq-body-large">
                      {props.page2 ?? (
              ...
              <a href={props.linkUrlPage3}>
                <div className="navbar-menu-item7">
                  <img
                    alt={props.page3ImageAlt}
                    src={props.page3ImageSrc}
                    className="navbar-page3-image2 thq-img-ratio-1-1"
                  />
                  <div className="navbar-content7">
                    <span className="navbar-page32 thq-body-large">
                      {props.page3 ?? (
              ...
              <a href={props.linkUrlPage4}>
                <div className="navbar-menu-item8">
                  <img
                    alt={props.page4ImageAlt}
                    src={props.page4ImageSrc}
                    className="navbar-page4-image2 thq-img-ratio-1-1"
                  />
                  <div className="navbar-content8">
                    <span className="navbar-page42 thq-body-large">
                      {props.page4 ?? (
...
Navbar.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1617131633412-39437b40a16b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjQwNTc0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Image for Features page',
  link2: undefined,
  linkUrlPage2: '#features',
  logoAlt: 'Temp Logo',
  logoSrc:
    'https://icons8.com/icon/111279/schedule',
  page3ImageAlt: 'Image for Integration page',
  linkUrlPage1: '#home',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1609609015424-fdb2ae1c1e98?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjQwNTc0Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1561395663-cfe4cf1be1e7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjQwNTc0N3w&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1707146177016-9906a2505a72?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjQwNTc0N3w&ixlib=rb-4.0.3&q=80&w=1080',
