    ...
    MuiCssBaseline: {
      styleOverrides: {
        'input:-webkit-autofill': {
          WebkitBoxShadow: '0 0 0 100px #ffffff inset', // Set autofill background color to #ffffff
          WebkitTextFillColor: '#000000', // Optional: Set text color
        },
      },
    },
  },
        ...
        <Container component="main" maxWidth="xs">
          <Box
            sx={{
              background: '#fff',
              borderRadius: 4,
              boxShadow: '0 4px 24px rgba(167, 170, 185, 0.07)',
              p: 4,
              mt: 6,
              display: 'flex',
