...
const CalendarSync = () => {
    ...
    const handleSyncGoogle = async () => {
        if (isSyncingRef.current) {
            console.log('[LOG] handleSyncGoogle skipped (already syncing)');
            return;
        }
        isSyncingRef.current = true;
        console.log('[LOG] handleSyncGoogle called');
        ...
        try {
            ...
            console.log('events pushed to Google Calendar', await api.post('/calendarsync/events/push/'));
            ...
            console.log('tasks pushed to Google Tasks', await googleCalendarManager.pushGoogleTasks());
    ...
    const handleSyncOutlook = async () => {
        ...
        setOutlookSyncError('');
        try {
            await outlookService.pullEvents();
            await outlookService.pullTasks();
    ...
    return (
        <Box maxWidth={600} mx="auto">
            <Typography variant="h4" gutterBottom>Calendar Sync</Typography>
            <Typography variant="body1" gutterBottom>
                Connect your Google Calendar or Outlook to sync your tasks and events between this app and your external calendars.
            </Typography>
            <Divider sx={{ my: 3 }} />
